        ...
        <div class="col-12">
            <div class="g-card">
                <div class="g-card-header d-flex justify-content-between align-items-center">
                    ...
                    @if($employee->salary)
                        <a href="{{ route('super-admin.salaries.edit', $employee->salary) }}" class="btn-link-google">Edit Details</a>
                    @else
                        <a href="{{ route('super-admin.salaries.create') }}?emp_id={{ $employee->emp_id }}" class="btn-link-google">Setup Salary</a>
                    @endif
                </div>
                <div class="g-card-body">
                    @if($employee->salary)
                    ...
                    @else
                        <div class="empty-state">
                            ...
                            <a href="{{ route('super-admin.salaries.create') }}?emp_id={{ $employee->emp_id }}" class="btn btn-primary-google mt-2">Configure Now</a>
                        </div>
                    @endif
                </div>
            </div>
