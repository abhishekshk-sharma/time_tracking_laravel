            ...
            <table class="table">
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td>
                            <a href="{{ route('super-admin.salaries.edit', $salary) }}" class="btn btn-sm btn-secondary">
                    ...
                    <tr>
                        <td colspan="11" style="text-align: center; padding: 40px; color: #86868b;">
                            ...
                            <div style="margin-top: 8px;">
                                <a href="{{ route('super-admin.salaries.create') }}" class="btn btn-primary">Add First Salary</a>
                            </div>
                        </td>
                    </tr>
                    @endforelse
