...
<div class="page-header">
    <div style="display: flex; justify-content: space-between; align-items: center;">
        <div>
            ...
            <p class="page-subtitle">View all notifications from your assigned employees</p>
        </div>
...
$(document).ready(function() {
            ...
            let html = `
                <div style="text-align: left;">
                    ...
                    <div style="text-align: center; margin-top: 20px; padding: 15px; background: #f8f9fa; border-radius: 8px;">
                        <a href="{{ route('admin.applications') }}" style="color: #007bff; text-decoration: none; font-weight: 500;">
    ...
    function markAsRead(notificationId, element) {
        ...
        const form = $('<form>', {
            method: 'POST',
            action: `{{ route("admin.notifications.read", ":id") }}`.replace(':id', notificationId)
        });
